...
- **Content:** the Channel Upgrade / Sub-network Router I / Sub-network Router II nodes (`standard-run-design.md §5`) get authored with **channel-count** ratings per cable tier (numbers TBD in a content pass), not flow rates. New cable-tier items gate on Engineering research.
