...
const DC = {
  ...
  label: 'rgba(200,205,212,0.55)',
  title: 'rgba(200,205,212,0.88)',
  subtitle: 'rgba(200,205,212,0.5)',
  postitBg: '#fef4a8',
  postitText: '#5a4a2a',
...
if (typeof document !== 'undefined' && !document.getElementById('dc-styles')) {
  ...
  s.textContent = [
    ...
    '.dc-editable:focus{background:rgba(255,255,255,.08);box-shadow:0 0 0 1.5px #8a72aa}',
    '[data-dc-slot]{transition:transform .18s cubic-bezier(.2,.7,.3,1)}',
    '[data-dc-slot].dc-dragging{transition:none;z-index:10;pointer-events:none}',
    '[data-dc-slot].dc-dragging .dc-card{box-shadow:0 12px 40px rgba(0,0,0,.5),0 0 0 2px #8a72aa;transform:scale(1.02)}',
    ...
    '.dc-grip:hover{background:rgba(255,255,255,.08)}',
    ...
    '.dc-labeltext:hover{background:rgba(255,255,255,.05)}',
    ...
    '  background:transparent;color:rgba(200,205,212,.5);display:flex;align-items:center;justify-content:center}',
    '.dc-expand:hover{background:rgba(255,255,255,.08);color:#c8cdd4}',
